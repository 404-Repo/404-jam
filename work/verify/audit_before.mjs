...
const ROOT = "/Users/atlas/404_jam_site/work/verify/beforebuild";
...
fs.writeFileSync('/Users/atlas/404_jam_site/work/verify/audit_before.json', JSON.stringify(out,null,1));
console.log('written');
